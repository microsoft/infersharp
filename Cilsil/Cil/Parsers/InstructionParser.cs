...
namespace Cilsil.Cil.Parsers
{
    internal abstract class InstructionParser
    {
        ...
        public static bool ParseCilInstruction(Instruction instruction, ProgramState state)
        {
            ...
            Log.WriteWarning($"Unable to parse instruction {instruction.OpCode.Code}");
        ...
        protected (CfgNode, CfgNode) CreateBranchConditionNodes(
            ProgramState state, Expression trueNodeCondition, Expression falseNodeCondition)
        {
